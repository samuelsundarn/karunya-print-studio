  ...
  return (
    <footer className="bg-foreground text-background">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-strong hover:shadow-premium transition-all duration-300 hover:scale-110 floating">
